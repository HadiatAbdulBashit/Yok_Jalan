    ...
    this.innerHTML = `
      <section id='aboutus'>
        ...
        <div class='row justify-content-evenly my-5'>
          <div class='col-lg-7 pe-3 d-flex flex-column justify-content-center text-center' data-aos="zoom-in-down" data-aos-offset="-2000">
          ...
          <div class='col-lg-3 d-flex justify-content-center' data-aos="zoom-in-up" data-aos-offset="-2000">
            <picture>
