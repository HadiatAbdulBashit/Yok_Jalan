    ...
    this.innerHTML = `
            <section id="welcome">
                <div class="row justify-content-evenly mb-5 pb-5">
                  <div class="col-lg-6 pe-3 d-flex flex-column justify-content-center text-center" data-aos="fade-right" data-aos-offset="90">
                  ...
                  <div class="col-lg-5" data-aos="fade-left" data-aos-offset="90">
                    <picture>
