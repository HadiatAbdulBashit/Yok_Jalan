              ...
              <div class="row d-flex justify-content-evenly">
                  <div class="col-md-5 col-10 m-3 text-center">
                      <div class="devCard mb-5 p-3">
                          ...
                          <div class="d-flex flex-row justify-content-evenly align-items-center pt-3 my-4 media">
                              <a href="https://github.com/putrinamahfudz" class="rounded-circle p-3">
                                  <img src="./images/media/github.png" alt="Github">
                              </a>
                              <a href="https://www.instagram.com/putputri19/" class="rounded-circle p-3">
                                  <img src="./images/media/instagram.png" alt="Instagram">
                              </a>
                              <a href="https://www.linkedin.com/in/putrinamahfudz/" class="rounded-circle p-3">
                                  <img src="./images/media/linkedin.png" alt="LinkedIn">
                              </a>
                          </div>
                      </div>
                  </div>
                  <div class="col-md-5 col-10 m-3 text-center">
                      <div class="devCard mb-5 p-3">
                          ...
                          <div class="d-flex flex-row justify-content-evenly align-items-center pt-3 my-4 media">
                              <a href="https://github.com/febbyputri" class="rounded-circle p-3">
                                  <img src="./images/media/github.png" alt="Github">
                              </a>
                              <a href="https://www.instagram.com/febbyputry_/" class="rounded-circle p-3">
                                  <img src="./images/media/instagram.png" alt="Instagram">
                              </a>
                              <a href="https://www.linkedin.com/in/febby-marshanda-5b3b3a1b1/" class="rounded-circle p-3">
                                  <img src="./images/media/linkedin.png" alt="LinkedIn">
                              </a>
                          </div>
                      </div>
              ...
              <div class="row d-flex justify-content-evenly">
                  <div class="col-md-5 col-10 m-3 text-center">
                      <div class="devCard mb-5 p-3">
                          ...
                          <div class="d-flex flex-row justify-content-evenly align-items-center pt-3 my-4 media">
                              <a href="https://github.com/HadiatAbdulBashit" class="rounded-circle p-3">
                                  <img src="./images/media/github.png" alt="Github">
                              </a>
                              <a href="https://www.instagram.com/" class="rounded-circle p-3">
                                  <img src="./images/media/instagram.png" alt="Instagram">
                              </a>
                              <a href="https://www.linkedin.com/in/hadiat-abdul-bashit-77b03b225/" class="rounded-circle p-3">
                                  <img src="./images/media/linkedin.png" alt="LinkedIn">
                              </a>
                          </div>
                      </div>
                  ...
                  <div class="col-md-5 col-10 m-3 text-center">
                      <div class="devCard mb-5 p-3">
                          ...
                          <div class="d-flex flex-row justify-content-evenly align-items-center pt-3 my-4 media">
                              <a href="https://github.com/MushlihNur" class="rounded-circle p-3">
                                  <img src="./images/media/github.png" alt="Github">
                              </a>
                              <a href="https://www.instagram.com/mushlih.nuris/" class="rounded-circle p-3">
                                  <img src="./images/media/instagram.png" alt="Instagram">
                              </a>
                              <a href="https://www.linkedin.com/in/mushlihNurIslam" class="rounded-circle p-3">
                                  <img src="./images/media/linkedin.png" alt="LinkedIn">
                              </a>
                          </div>
                      </div>
